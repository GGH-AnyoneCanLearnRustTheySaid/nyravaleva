        ...
        <div className="w-full max-w-5xl flex flex-col gap-12 md:gap-16">
          ...
          >
             <p className="text-neutral-400 font-serif italic lowercase text-base md:text-lg leading-relaxed tracking-wide">
               <span className="capitalize">Nyra Vale</span> is a texas-born singer and voice artist who pours her whole heart into everything she does. from soulful original tracks to bringing characters to life on screen, her voice has a way of making you feel something.
             </p>
             <p className="text-neutral-400 font-serif italic lowercase text-base md:text-lg leading-relaxed tracking-wide">
               <span className="capitalize">Nyra Vale</span> is a singer, songwriter, and voice artist from texas with a simple philosophy: show up, be real, and sing like you mean it. whether she's in the studio recording original music or voicing characters for tv, she brings the same thing every time - all of herself.
             </p>
          </motion.div>

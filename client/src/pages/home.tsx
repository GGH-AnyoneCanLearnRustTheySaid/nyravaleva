      ...
      <main className="pt-32 pb-20 px-4 md:px-12 flex flex-col items-center min-h-screen">
        ...
        <div className="w-full max-w-5xl flex flex-col gap-12 md:gap-16">
          ...
          <motion.div 
            ...
            className="w-[78%] mx-auto relative aspect-video bg-[#0d0d0d] overflow-hidden mb-16"
          >
            <motion.img 
              src={heroImage} 
          ...
          <div className="w-full flex flex-col gap-6">
            ...
            <div className="w-full">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-20">
                ...
                >
                  ...
                  <div>
                    <h3 className="text-lg font-display text-white tracking-widest uppercase mb-2">CHARACTER SINGING DEMO</h3>
            ...
            <div className="w-full">
               ...
               <div className="w-full text-center py-6">
                 <p className="text-neutral-400 font-sans text-base font-bold tracking-wide">
